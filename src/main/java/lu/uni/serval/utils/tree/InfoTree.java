...
public class InfoTree {
     ...
     * 
     * @param aInputTree an LabelTreeNode object
     ...
     * @return 
     */
    private int gatherInfo(LabelTreeNode aT, int postorder) {
        int currentSize = 0;
        int childrenCount = 0;
        int descSizes = 0;
        int krSizesSum = 0;
        ...
        for (Enumeration e = aT.children(); e.hasMoreElements();) {
            ...
            postorder = gatherInfo((LabelTreeNode) e.nextElement(), postorder);
