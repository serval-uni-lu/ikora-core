...
public class ArgumentResolver {
    ...
    public static void resolve(KeywordCall call, Runtime runtime) {
        ...
        call.getKeyword().ifPresent(k -> resolveArgumentKeywords(call, k, runtime));

        updateScope(call, runtime);
    }

    public static void resolveArgumentKeywords(KeywordCall call, Keyword keyword, Runtime runtime){
